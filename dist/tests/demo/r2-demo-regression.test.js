    ...
    describe('action sequence steps', () => {
        ...
        it('passage strictly increases across CastAnchorPulse steps', () => {
            ...
            for (let i = 1; i < castSteps.length; i++) {
                expect(castSteps[i].pressureMeter.passage).toBeGreaterThan(castSteps[i - 1].pressureMeter.passage);
            }
        });
...
describe('Act II — Continuation Loop regression fixture', () => {
    ...
    describe('final state', () => {
        ...
        it('district pressure decreases from initial', () => {
            expect(actII.finalState.districtPressureLevel).toBeLessThan(actII.initialState.districtPressureLevel);
        });
        it('district resonance stability increases from initial', () => {
            expect(actII.finalState.districtResonanceStability).toBeGreaterThan(actII.initialState.districtResonanceStability);
        });
        it('district restoration progress increases from initial', () => {
            expect(actII.finalState.districtRestorationProgress).toBeGreaterThan(actII.initialState.districtRestorationProgress);
        });
