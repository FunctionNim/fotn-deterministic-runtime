...
export var DistrictCultureTone;
(function (DistrictCultureTone) {
    DistrictCultureTone["Stable"] = "Stable";
    DistrictCultureTone["Guarded"] = "Guarded";
    DistrictCultureTone["Fragmented"] = "Fragmented";
    DistrictCultureTone["Restorative"] = "Restorative";
    DistrictCultureTone["Reborn"] = "Reborn";
    DistrictCultureTone["Mythic"] = "Mythic";
})(DistrictCultureTone || (DistrictCultureTone = {}));
...
function resolveTone(input) {
    if (input.era === CivilizationEra.Transcendent)
        return DistrictCultureTone.Mythic;
    if (input.era === CivilizationEra.Reborn)
        return DistrictCultureTone.Reborn;
    if (input.era === CivilizationEra.Fractured)
        return DistrictCultureTone.Fragmented;
    if (input.era === CivilizationEra.Strained)
        return DistrictCultureTone.Guarded;
    if (input.restorationLegacyStage === RestorationLegacyStage.ContinuityAnchor)
        return DistrictCultureTone.Restorative;
    return DistrictCultureTone.Stable;
}
function symbolicStrength(stage) {
    switch (stage) {
...
function restorationStrength(stage) {
    switch (stage) {
...
function exhaustiveRestorationStageCheck(value) {
